      ...
      >
        {[...Array(12)].map((_, i) => (
          <div
            key={i}
            className={cn(
              'bg-[rgba(118,118,128,0.08)] rounded-2xl animate-pulse',
  ...
  if (images.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        <div className="w-24 h-24 rounded-full bg-[rgba(118,118,128,0.08)] flex items-center justify-center mb-4">
          <svg
            className="w-12 h-12 text-[#3a3a3c]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
        ...
        <h3 className="text-lg font-medium text-[#8e8e93] mb-2">暂无图片</h3>
        <p className="text-sm text-[#8e8e93]">上传一些图片开始管理吧</p>
      </div>
    );
  }
